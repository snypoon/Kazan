...
$(window).ready( function( $ ) {
	...
	$('.slider_1').waitForImages(function() {
	...
	let headerTimer = function(){
		...
		function initializeClock(id, endtime) {
			...
			var daysSpan = clock.querySelector('.header__days');
			var hoursSpan = clock.querySelector('.header__hours');
			var minutesSpan = clock.querySelector('.header__minutes');
			var secondsSpan = clock.querySelector('.header__seconds');
		...
		initializeClock('countdown__header', deadline);
	};
	...
	let footerTimer = function(){
		...
		function initializeClock(id, endtime) {
			var clock = document.getElementById(id);
			var daysSpan = clock.querySelector('.footer__days');
			var hoursSpan = clock.querySelector('.footer__hours');
			var minutesSpan = clock.querySelector('.footer__minutes');
			var secondsSpan = clock.querySelector('.footer__seconds');
		...
		var deadline="July 09 2021 00:00:00 GMT+0300";
		initializeClock('countdown__footer', deadline);
	};
